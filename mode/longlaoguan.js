...
game.import('mode',function(lib,game,ui,get,ai,_status){
	return {
		...
		translate:{
			...
			zaoankeke: '早安一刀',
			zaoankeke_info: '<font color=#f66>锁定技</font> 当你使用【杀】指定目标后，目标需弃置一张牌；若此【杀】为属性杀，则改为交给你一张牌。',
			jierizhanbei: '扳手战备',
			jierizhanbei_info: '<font color=#f66>锁定技</font> 你使用过装备牌的回合内手牌上限视为5.回合结束时，若本回合你没有使用过装备牌，你随机从牌堆内获得一张装备牌。',
			esuyingye: '滥觞之至',
			...
			zhengzhengrishang_info:'<font color=#f66>锁定技</font> 出牌阶段开始时，你将手牌调整至全场唯一最多。若已为最多，则改为获得一张【逼宫】。一个回合结束时，你将手牌调整至不为全场最少。',
			yugaimizhang:'欲盖弥彰',
			yugaimizhang_info:'<font color=#f66>锁定技</font> 你的手牌上限始终为5。一轮开始时，亮出牌堆顶牌，本轮内你成为此花色牌目标的回合结束时，你可以使用一张牌，此牌可以额外指定任意目标。',
			zuoyututan:'坐於涂炭',
			zuoyututan_info:'<font color=#f66>锁定技</font> 转换技。一轮开始时，令所有反抗军①随机废除一个装备栏②手牌上限-1③获得一张进入弃牌堆后即移出游戏的【毒】。形态切换后，复原反抗军。',
			// _feiyang:"飞扬",
			// _bahu:"跋扈",
			// _feiyang_info:"判定阶段开始时，若你的判定区有牌，则你可以弃置两张手牌，然后弃置你判定区的一张牌。每回合限一次。",
			// _bahu_info:"<font color=#f66>锁定技</font> 准备阶段开始时，你摸一张牌。出牌阶段，你可以多使用一张【杀】。",
			// dulun: '独轮车',
