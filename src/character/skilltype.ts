...
type skillAttribute = 'direct' | 'forced' | 'silent' | 'unique' | 'forceunique' | skillTypeTag | 'skillAnimation' | 'firstDo' | 'lastDo' | skillMark | skillAlwaysTrue
type skillMark = 'mark' | 'onremove' | 'cardAround' | 'notemp'
type skillTypeTag = 'locked' | 'limited' | 'juexingji' | 'zhuSkill' | 'dutySkill'
type skillAlwaysTrue = 'filterCard' | 'filterTarget' | 'multitarget' | 'frequent' | 'forceDie' | 'audio'
