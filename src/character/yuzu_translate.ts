...
export default {
    ...
    chutan_info: `出牌阶段限一次，你可以弃置一张牌，标记*一名其他角色。<br>
    ...
    kangqie: `远弦`,
    kangqie_info: `结束阶段，你可以翻面*并回复一点体力，令一名角色受到一点无来源的伤害；若你于本局游戏内受到了至少7次无来源的伤害，或你体力为1，此技能也可以在出牌阶段发动。`,
    kangqie_append: lib.figurer(`特性：任务 直接伤害`),
