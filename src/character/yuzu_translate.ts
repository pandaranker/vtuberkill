...
export default {
    ...
    xiban: `系绊`,
    xiban_info: `其他角色的回合结束时，若其造成了伤害，你可以弃置X张「士」令其选择一项：弃置等量的牌；若你已受伤，令你回复1点体力。<br>
    （X为你当前体力值）`,
    yongtuan: `拥团`,
    ...
    （X为你已损失的体力值+1）`,
    ysxiangxing: `翔星`,
    ysxiangxing_info: `出牌阶段限一次，你可以将所有手牌置于牌堆顶，然后对攻击范围内一名角色造成1点伤害。`,
    ...
    dianying: `店营`,
    dianying2: `店营`,
    dianying_info: `其他角色于出牌阶段限一次，其可以将至少一张手牌扣置于你的武将牌旁，称为「面」，然后其可以将两张「面」明置以回复1点体力。<br>
    ...
    liaohu: `逃杀疗护`,
    liaohu_info: `一个回合结束时，若你于本回合内造成了伤害，你可以回复1点体力，<br>若『花吻交染』已发动，改为令最近一次『花吻交染』的目标回复体力。`,
