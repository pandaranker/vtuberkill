	...
	return {
		...
		//		prepare:'give',
			...
			gengu:{
				...
				callback:function(){
					'step 0'
					console.log(player.hasCardAround())
		...
		translate:{
			...
			ap_Azusa_ab: '界阿梓',
			puyu: '璞玉',
			puyu_info: '出牌阶段开始时，你可以令一名角色弃一张牌，本阶段内，你所有手牌的牌名视为之，且你使用5张牌或一名角色获得10张牌后立即结束此阶段。',
			appojian: '破茧',
			appojian_info: '锁定技 你使用牌造成伤害后，你令体力最多的角色失去一点体力，体力最少的角色回复一点体力，若你满足至少一项，立即结束当前回合。',
