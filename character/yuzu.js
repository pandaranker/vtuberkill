    ...
    return {
        ...
        skill: {
                ...
                subSkill: {
                    date: {
                        ...
                        filter(event, player) {
                            if (player.storage.qishi === true)
                                return false;
                            if (player.storage.qishi_date && player.storage.qishi_date.includes(event.player))
                                return false;
                            return true;
                        },
                        content() {
                    ...
                    drawBy: {
                        ...
                        filter(event, player) {
                            ...
                            if (get.type2(event.card) != 'trick')
                                return false;
                            if ((_b = (_a = player.storage) === null || _a === void 0 ? void 0 : _a.tianyi_drawBy) === null || _b === void 0 ? void 0 : _b.includes(get.suit(event.card)))
                                return false;
                    ...
                    lose: {
                        ...
                        filter(event, player) {
                            for (let i in event.gaintag_map) {
                                if (event.gaintag_map[i].includes('zhongjizhimeng'))
                                    return true;
                            }
                        },
                        direct: true,
            ...
            mianmo: {
                ...
                content() {
                    ...
                    if (result.bool) {
                        ...
                        if (player.storage.tiaolv_up && player.storage.tiaolv_up.includes(event.card))
                            event.goto(4);
                        if (player.storage.tiaolv_down && player.storage.tiaolv_down.includes(event.card))
                            event.goto(6);
                    }
                    else {
                        event.finish();
            ...
            ming_niwei: {
                ...
                priority: 3,
                filter(event, player) {
                    if (event.player.hasSkill('niwei') && event.player.storage.niwei && event.player.storage.niwei.includes(event.name))
                        return true;
                    if (event.player != player)
                        return false;
            ...
            aswusheng: {
                ...
                logTarget(event, player) {
                    if (event.name == 'respond')
                        return event.source;
                    if (['sha', 'qi', 'jiu', 'tao'].includes(event.card.name))
            ...
            quanyu: {
                ...
                check(event, player) {
                    ...
                    if (player.hp < num)
                        return false;
                    if (['shandian', 'du'].includes(event.card.name))
                        return false;
                    ...
                    mark: {
                        ...
                        filter(event, player) {
                            ...
                            let list = event.cards.filter(card => {
                                if (event.js && event.js.includes(card))
                                    return false;
            ...
            baifei: {
                ...
                filter(event, player) {
                    ...
                    if (player == event.source)
                        return !characters.includes(event.player);
                    else if (event.source)
                        return !characters.includes(event.source);
                },
                content() {
                    'step 0';
            ...
            zhengen: {
                ...
                filter(event, player) {
                    ...
                    if (player == event.source)
                        return player.countCards('h') && event.player.countDiscardableCards(player, 'ej') && !characters.includes(event.player);
                    else if (event.source)
                        return player.countCards('h') && event.source.countDiscardableCards(player, 'ej') && !characters.includes(event.source);
                },
                content() {
                    'step 0';
            ...
            ganfen: {
                ...
                check(event, player) {
                    if (['phaseDraw', 'phaseUse'].includes(event.name) || player.hp <= 1)
                        return false;
                ...
                content() {
                    ...
                    player.judge(card => {
                        ...
                        if (event.judgeResult.number <= evt.gainnum)
                            player.gainPlayerCard([1, evt.num], evt.target, true);
                        else
                            evt.target.recover();
                    });
                },
            ...
            lianyin: {
                ...
                priority: 996,
                filter(event, player) {
                    if (event.name == 'respond' && !player.awakenedSkills.includes('guixiang'))
                        return false;
            ...
            xuanying: {
                ...
                priority: 996,
                filter(event, player) {
                    if (event.name == 'respond' && !player.awakenedSkills.includes('houfan'))
                        return false;
            ...
            zhanchong: {
                trigger: { player: 'loseEnd' },
                filter(event, player) {
                    if (event.getParent().name && ['useCard', 'addJudge'].includes(event.getParent().name))
                        return false;
                    if (!event.visible)
                        return false;
                    for (let i = 0; i < event.hs.length; i++) {
            ...
            shengang: {
                ...
                subSkill: {
                    judge: {
                        ...
                        filter(event, player) {
                            if (!game.filterPlayer(cur => get.distance(player, cur, 'pure') == 1, [player]).includes(event.player))
                                return false;
                ...
                content() {
                    ...
                    if (result.bool && result.links) {
                        ...
                        for (let i = 0; i < links.length; i++) {
                            if (event.topCards.includes(links[i]))
                                bottom.push(links[i]);
                            if (event.bottomCards.includes(links[i]))
                                top.unshift(links[i]);
                        }
