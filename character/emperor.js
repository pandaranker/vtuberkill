        ...
        skill: {
            ...
            shenghuang: {
                ...
                subSkill: {
                    ...
                    lose: {
                        ...
                        priority: 777,
                        filter(event, player) {
                            if (!(event.getParent().cards || event.card))
                                return false;
            ...
            renzhan: {
                ...
                content() {
                    ...
                    player.chooseControlList(['获得这些牌',
                        ...
                        if (player.countCards('h', { name: 'sha' }) >= 1 && event.cards.length <= 3)
                            return 1;
                        return 0;
                    });
                    'step 3';
                    ...
                    discard: {
                        ...
                        content() {
                            ...
                            player.chooseControlList(['令一名其他角色获得「小兔子」标记',
                                '令所有「小兔子」各摸一张牌'], true, function (event, player) {
            ...
            liuxuan: {
                ...
                content() {
                    ...
                    'step 4';
                    if (event.link == 'liuxuan_jiangzui' && ((_a = result === null || result === void 0 ? void 0 : result.targets) === null || _a === void 0 ? void 0 : _a.length)) {
                        event.target = result.targets[0];
                        player.logSkill(event.link, event.target);
                        event.target.chooseCard('he', '无限溜旋-犟嘴：将一张牌交给' + get.translation(player), 1, true).ai = card => {
                    ...
                    'step 5';
                    if (event.link == 'liuxuan_jiangzui' && ((_b = result === null || result === void 0 ? void 0 : result.cards) === null || _b === void 0 ? void 0 : _b.length)) {
                    ...
                    'step 7';
                    if (event.link == 'liuxuan_jiangzui' && ((_c = result.links) === null || _c === void 0 ? void 0 : _c.length)) {
                    ...
                    if (event.link) {
                        ...
                        if (['liuxuan_lakua', 'liuxuan_keai', 'liuxuan_haixiu'].contains(event.link))
                            player.logSkill(event.link);
                        player.addSkill(event.link);
                        game.delay();
                        if (lib.skill.liuxuan.process)
                            lib.skill.liuxuan.process('liuxuan', event.link, player);
                    }
                    event.goto(1);
                },
                mod: {
                ...
                content() {
                    ...
                    if (event.source != player && event.source.countCards('h')) {
                        ...
                        for (var i = 0; i < wanxiang.length; i++) {
                            if (wanxiang[i].hasGaintag('xinjia'))
                                event.xinjia = true;
                        }
                    }
                    event.filterCards = [];
                    ...
                    if (event.xinjia && event.allBy <= 2) {
                        event.allBy++;
                        if (event.filterCards.length > 0 || event.allBy <= 2)
                            event.goto(3);
                    }
                    'step 5';
            ...
            shizu: {
                ...
                filter(event, player) {
                    ...
                    if (typeof name == 'string' && event.player.isIn())
                        return true;
                },
                logTarget: 'player',
                content() {
