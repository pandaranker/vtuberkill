window.config={
	...
	all:{
		...
		sgsmodes:['identity','versus','doudizhu','longlaoguan','single','brawl','connect'],//,'guozhan'
		stockmode:['identity','versus','boss','doudizhu','longlaoguan','single','connect','brawl'],//,'guozhan','tafang','chess','stone'
