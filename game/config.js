window.config={
	...
	all:{
		...
		sgsmodes:['identity','doudizhu','versus','longlaoguan','single','brawl','connect'],//,'guozhan'
		stockmode:['identity','doudizhu','versus','boss','longlaoguan','single','connect','brawl'],//,'guozhan','tafang','chess','stone'
