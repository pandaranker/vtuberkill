...
(function (factory) {
    ...
    mixin(get, {
        ...
        is: {
            ...
            banWords: function (str) {
                if (get.is.emoji(str))
                    return true;
                for (let i of window.bannedKeyWords) {
                    if (str.indexOf(i) != -1)
                        return true;
                }
                return false;
        ...
        ip: function () {
            if (localStorage.getItem('noname_inited') !== 'nodejs')
                return '';
        ...
        config: function (item, mode = lib.config.mode) {
    ...
    return str;
    skillInfoTranslation(name, player, PlayerModel_1.default);
    string;
    {
